...
let history=[]; let last={subject:'',body:''}; let recorder;
...
<div class="card"><div class="section-title">Resultaat</div><div class="field"><label>Onderwerp</label><input id="subject" class="input"></div><div class="field"><label>Bericht</label><textarea id="body" class="textarea" style="min-height:220px"></textarea></div><div class="row"><button class="btn secondary small act" data-act="regenerate">Opnieuw</button><button class="btn secondary small act" data-act="shorter">Korter</button><button class="btn secondary small act" data-act="friendlier">Vriendelijker</button><button class="btn secondary small act" data-act="formal">Formeler</button><button class="btn secondary small act" data-act="informal">Informeler</button><button class="btn secondary small" id="copyMail">Kopiëren</button><button class="btn" id="openMail">Mail openen</button></div></div>`;
